                    ...
                    <div class="overflow-auto">
                        <b-table thead-class="thead-color" emptyText="Data Not Found" small show-empty bordered hover :items="itemList" :fields="fields">
                            ...
                            <template v-slot:cell(action)="data">
                                ...
                                <b-button title="Active/Inactive" class="ml-2 btn btn-primary btn-sm" @click="editRouter(data.item, 'salon-seats/create')"> <i class="ri-edit-line"></i> </b-button>
                            </template>
                        </b-table>
                    </div>
                </b-overlay>
...
export default {
    ...
    computed: {
        fields () {
            const labels = [
                ...
                { label: 'Service Person Name', class: 'text-center' },
    ...
    methods: {
        toggleStatus (item) {
            RestApi.putData(baseUrl, `/salon-seats/status/${item.id}/`, { ...item, status: item.status ? 0 : 1 }).then(response => {
        ...
        loadData () {
            ...
            RestApi.getData(baseUrl, 'salon-seats', params).then(response => {
                if (response.success) {
